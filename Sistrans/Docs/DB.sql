...
ALTER TABLE CONTRATO ADD CONSTRAINT CONTRATO_FK4 FOREIGN KEY (IDVIVIENDA) REFERENCES VIVIENDA(IDVIVIENDA);
...
ALTER TABLE OFERTA ADD CONSTRAINT OFERTA_FK1 FOREIGN KEY (IDOPERADOR) REFERENCES OPERADOR(IDOPERADOR);
...
ALTER TABLE OFERTA ADD CONSTRAINT OFERTA_FK4 FOREIGN KEY (IDAPARTAMENTO) REFERENCES APARTAMENTO(IDAPARRTAMENTO);
